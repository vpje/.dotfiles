...
(custom-set-variables
 ...
 '(safe-local-variable-values
   '((projectile-project-install-cmd . "cd tools && BOARD=0 ./configure_image_and_flash_board_dev.sh")
     ...
     (projectile-compilation-dir string-join projectile-project-root "/../thingsee_tag_wp/")
     ...
     (projectile-project-compilation-cmd . "rm -rf build && make")
     (projectile-compilation-dir . projectile-project-root)
     (projectile-project-compilation-cmd . "cd ~/work/ts/sensors/thingsee_tag_wp50/thingsee_tag_wp && rm -rf build && make")
